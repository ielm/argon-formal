...
// Module: ArgonFormal.TypeSystem.Soundness.CwaOwa
...
LEAN_EXPORT lean_object* initialize_argon_x2dformal_ArgonFormal_TypeSystem_Soundness_CwaOwa(uint8_t builtin) {
lean_object * res;
